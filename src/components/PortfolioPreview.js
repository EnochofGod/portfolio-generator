          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-6 mb-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <button onClick={() => setView('config')} className="flex items-center text-xs font-semibold px-4 py-2 rounded-xl bg-white/80 backdrop-blur-sm text-blue-600 hover:text-blue-800 transition-all duration-300 border border-blue-200/50 hover:border-blue-300 shadow-sm hover:shadow-md">
                  <ArrowLeft className="w-2 h-2 mr-2" /> Edit Data
                </button>
                <button onClick={() => setShowExportModal(true)} className="flex items-center text-xs font-semibold px-4 py-2 rounded-xl bg-green-600 text-white hover:bg-green-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                  <Code className="w-2 h-2 mr-2" /> Export HTML
                </button>
                <button onClick={openGeneratedHtmlInNewTab} className="flex items-center text-xs font-semibold px-4 py-2 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <button onClick={() => setView('config')} className="flex items-center text-xs font-semibold px-4 py-2 rounded-xl bg-white/10 backdrop-blur-sm text-cyan-300 hover:text-white transition-all duration-300 border border-white/20 hover:border-cyan-400 shadow-sm hover:shadow-md">
