...
const WelcomePage = ({ setTemplate, data }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #FFFFFF 0%, #F3F4F6 100%)' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 text-center mt-20 mb-16 px-4">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-indigo-500 tracking-tight mb-6 leading-tight">
          Portfolio
          <br />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Choose Your Style</h2>
